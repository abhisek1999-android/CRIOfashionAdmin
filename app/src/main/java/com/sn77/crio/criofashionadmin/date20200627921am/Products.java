...
public class Products {
   ...
   String brand_name;
    ...
    public Products(String thumb_image) {
        this.thumb_image = thumb_image;
    }
    ...
    public void setBase_material(String base_material) {
        this.base_material = base_material;
    }

    public String getJewellery_plating() {
        return jewellery_plating;
    }

    public void setJewellery_plating(String jewellery_plating) {
        this.jewellery_plating = jewellery_plating;
    }
