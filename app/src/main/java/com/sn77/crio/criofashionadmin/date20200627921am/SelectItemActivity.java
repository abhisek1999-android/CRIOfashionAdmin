    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                mainActivityIntent.putExtra("parentCategory",expandableListTitle.get(groupPosition));
                mainActivityIntent.putExtra("childCategory", expandableListDetail.get(expandableListTitle.get(groupPosition)).get(childPosition));
